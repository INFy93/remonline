                                ...
                                >
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="#" @click.prevent="fillMalfunction" class="text-sm text-blue-600 hover:underline">Перенастройка ОС</a>
                                            <a href="#" @click.prevent="fillMalfunction" class="text-sm text-blue-600 hover:underline">Черный экран</a>
                                            <a href="#" @click.prevent="fillMalfunction" class="text-sm text-blue-600 hover:underline">Не включается</a>
                                        </div>
                                        <textarea
                                    ...
                                    <div class="mb-6">
                                        ...
                                        >
                                        <div class="flex space-x-2">
                                            <a href="#" @click.prevent="fillComplection" class="text-sm text-blue-600 hover:underline">Ноут + зарядка</a>
                                            <a href="#" @click.prevent="fillComplection" class="text-sm text-blue-600 hover:underline">Ноут + сумка + зарядка</a>
                                            <a href="#" @click.prevent="fillComplection" class="text-sm text-blue-600 hover:underline">Ноут без зарядки</a>
                                            <a href="#" @click.prevent="fillComplection" class="text-sm text-blue-600 hover:underline">Полная</a>
                                            <a href="#" @click.prevent="fillComplection" class="text-sm text-blue-600 hover:underline">Со шнуром</a>
                                        </div>
                                        <textarea
                                            v-model="
